...
EditText name,from,to,adults,kids,passenger,date,myclass,phone,address;
LinearLayout layout;
Spinner spinner;
Context context;
...
DatabaseReference ref1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayAdapter<String> adapter = new ArrayAdapter<>(systeminformation.this, android.R.layout.simple_spinner_dropdown_item, myarraylist);
...
editor.apply();
        Intent i=new Intent(systeminformation.this,boardingpass.class);
