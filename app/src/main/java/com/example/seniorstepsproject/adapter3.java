...
public class adapter3 extends RecyclerView.Adapter<adapter3.myvieww> {
    ArrayList<insertmydata> list;
    Context context;
    public adapter3 (ArrayList<insertmydata>l,Context c){
        this.list=l;
        this.context=c;
    ...
    public myvieww onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.listitemtrain,parent,false);
        return new myvieww(view) ;

    }

    @Override
    public void onBindViewHolder(@NonNull myvieww holder,final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, checkbus.class);
    ...
    class myvieww extends RecyclerView.ViewHolder{
