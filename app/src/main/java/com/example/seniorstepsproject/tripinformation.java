...
public class tripinformation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tripinformation);
       ...
       query.addValueEventListener(new ValueEventListener() {
        ...
        final ArrayAdapter<String> adapter = new ArrayAdapter<>(tripinformation.this, android.R.layout.simple_spinner_dropdown_item, myarraylist);
        ...
        layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                Intent i=new Intent(tripinformation.this,searchtrip.class);
