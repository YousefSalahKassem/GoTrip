...
public class checkbus extends AppCompatActivity {

    TextView passengername,adult,kid,start,finish,starttime,date,price,chooseclass,phone,totalprice;
    Firebase fire4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String a= myintent.getStringExtra("from");
        ...
        insertl.setPassport(null);
        insertl.setPrice(ss);
        insertl.setTypetravel(g);
        insertl.setChooseclass(f);
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(checkbus.this,getbusticket.class);
                ...
                PendingIntent intent=PendingIntent.getActivity(checkbus.this,0,i,PendingIntent.FLAG_UPDATE_CURRENT);
                Notification notification=new NotificationCompat.Builder(checkbus.this,notificationchanels.Chanel1_ID).setSmallIcon(R.drawable.ic_directions_bus_black_24dp).setContentTitle("booking successful").setContentText("your booking confirmed !! thanks for this trust").setSubText("congratulations !!").setPriority(NotificationCompat.PRIORITY_HIGH).setCategory(NotificationCompat.CATEGORY_MESSAGE).setColor(Color.BLUE).addAction(R.drawable.ic_directions_bus_black_24dp,"Ticket",intent).setAutoCancel(true).setOnlyAlertOnce(true).build();
