...
public class checktrip extends AppCompatActivity {
  ...
  inserttofirebase insertl=new inserttofirebase();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checktrip);
...
insertl.setDate(d);
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(checktrip.this,gettripticket.class);
                ...
                PendingIntent intent=PendingIntent.getActivity(checktrip.this,0,i,PendingIntent.FLAG_UPDATE_CURRENT);
                Notification notification=new NotificationCompat.Builder(checktrip.this,notificationchanels.Chanel1_ID).setSmallIcon(R.drawable.ic_directions_boat_black_24dp).setContentTitle("booking successful").setContentText("your booking confirmed !! thanks for this trust").setSubText("congratulations !!").setPriority(NotificationCompat.PRIORITY_HIGH).setCategory(NotificationCompat.CATEGORY_MESSAGE).setColor(Color.BLUE).addAction(R.drawable.ic_directions_boat_black_24dp,"Ticket",intent).setAutoCancel(true).setOnlyAlertOnce(true).build();
