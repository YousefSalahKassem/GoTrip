...
public class checkplane extends AppCompatActivity {
...
LinearLayout linearLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checkplane);
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(insertl.getEmail().equals(firebase.getEmail())){
                    Intent i=new Intent(checkplane.this,getplanceticket.class);
                    ...
                    PendingIntent intent=PendingIntent.getActivity(checkplane.this,0,i,PendingIntent.FLAG_UPDATE_CURRENT);
                    Notification notification=new NotificationCompat.Builder(checkplane.this,notificationchanels.Chanel1_ID).setSmallIcon(R.drawable.ic_local_airport_black_24dp).setContentTitle("booking successful").setContentText("your booking confirmed !!"+ insertl.getName()+" thanks for this trust").setSubText("congratulations !!").setPriority(NotificationCompat.PRIORITY_HIGH).setCategory(NotificationCompat.CATEGORY_MESSAGE).setColor(Color.BLUE).addAction(R.drawable.ic_local_airport_black_24dp,"Ticket",intent).setAutoCancel(true).setOnlyAlertOnce(true).build();
