...
public class getplanceticket extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_getplanceticket);
calling();
        Intent i=getIntent();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(getplanceticket.this,menu.class));
