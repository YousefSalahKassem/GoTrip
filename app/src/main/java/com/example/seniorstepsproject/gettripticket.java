...
public class gettripticket extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gettripticket);
        calling();
        Intent i=getIntent();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(gettripticket.this,menu.class));
